{{-- <x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input  class="block mt-1 w-full" type="text" id="name" name="name" :value="old('name')" required autofocus autocomplete="name" />
            ...
            <div class="card mb-0">
              <div class="card-body">
                ...
                <form method="POST" action="{{ route('register') }}">
                  ...
                  <button class="btn btn-primary w-100 fs-4 mb-4 rounded-2">Sign Up</button>
